            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('companies.update', $company->id) }}" method="post"
                        ...
                        <div class="mb-5">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900">{{ __('web.name') }}</label>
                        ...
                        <div class="mb-5">
                            <label for="website"
                                class="block mb-2 text-sm font-medium text-gray-900">{{ __('web.website') }}</label>
                        ...
                        <div class="mb-5">
                            ...
                            <img src="{{ asset('storage/' . $company->getFirstMedia('company')->id . '/' . $company->getFirstMedia('company')->file_name) }}"
